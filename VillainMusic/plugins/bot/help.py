...
from VillainMusic.utils.database import get_lang
from VillainMusic.utils.decorators.language import LanguageStart, languageCB
from VillainMusic.utils.inline.help import (
    help_back_markup,
    private_help_panel,
    help_pannel_page1,
    help_pannel_page2,
...
async def helper_private(
    ...
    if is_callback:
        ...
        from VillainMusic.utils.inline.help import help_pannel_page1
        ...
        from VillainMusic.plugins.bot.start import DEFAULT_PHOTO
        try:
...
async def help_com_group(client, message: Message, _):
    from VillainMusic.utils.inline.help import private_help_panel
...
async def helper_cb(client, CallbackQuery, _):
    ...
    async def custom_edit(*args, **kwargs):
        kwargs["disable_web_page_preview"] = True
        return await original_edit(*args, **kwargs)
    CallbackQuery.edit_message_text = custom_edit
